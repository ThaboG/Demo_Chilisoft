...
namespace Demo.DAL.Migrations
{
    ...
    [Migration("20210520153520_AddErrorLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demo.DAL.Entities.Admins", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(9734), new TimeSpan(0, 2, 0, 0, 0)),
                            Firstname = "Thabo",
                            IsDeleted = false,
                            Lastname = "Gelenja",
                            MobileNo = "0734336271",
                            ModifiedDate = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(9747), new TimeSpan(0, 2, 0, 0, 0)),
                            SyncClientID = new Guid("2a8fc445-8524-47ad-8986-6644fbdac104"),
                            SyncTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(9756), new TimeSpan(0, 2, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("Demo.DAL.Entities.ApiUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 455, DateTimeKind.Unspecified).AddTicks(1293), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedDate = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 459, DateTimeKind.Unspecified).AddTicks(2853), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("Demo.DAL.Entities.Departments", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(5223), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Reception",
                            SyncClientID = new Guid("36dc3535-8c3b-402c-8356-50c229a7ed4d"),
                            SyncTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(5259), new TimeSpan(0, 2, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("Demo.DAL.Entities.ErrorLog", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demo.DAL.Entities.UserAdminRel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 464, DateTimeKind.Unspecified).AddTicks(1430), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedDate = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 464, DateTimeKind.Unspecified).AddTicks(1440), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("Demo.DAL.Entities.UserTypes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(2202), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Admin",
                            SyncClientID = new Guid("e102b502-ca8c-404c-a5b2-b71e6af9df52"),
                            SyncTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(2884), new TimeSpan(0, 2, 0, 0, 0)),
                            UserType = 0
                        });
                });
            ...
            modelBuilder.Entity("Demo.DAL.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(6840), new TimeSpan(0, 2, 0, 0, 0)),
                            IsDeleted = false,
                            ModifiedDate = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(6851), new TimeSpan(0, 2, 0, 0, 0)),
                            Password = "TestPassword",
                            SyncClientID = new Guid("2219769a-31c5-4acd-a51a-e1312dd11631"),
                            SyncTime = new DateTimeOffset(new DateTime(2021, 5, 20, 17, 35, 11, 463, DateTimeKind.Unspecified).AddTicks(6862), new TimeSpan(0, 2, 0, 0, 0)),
