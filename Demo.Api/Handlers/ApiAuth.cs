...
using ApiUser = Demo.Service.Logic.ApiService;
...
namespace Demo.Api.Handlers
{
    public class ApiAuth 
    {
        ...
        public ApiAuth(RequestDelegate next, BasicAuthenticationOptions options)
        {
            this._next = next;
        ...
        private bool CheckIsValidRequest(HttpContext context, out string username)
        {
            ...
            var ApiUs = ApiUser.Login(basicAuthHeader.UserName, basicAuthHeader.Password);

            return basicAuthHeader.IsValidBasicAuthenticationHeaderValue && ApiUs;
        }
